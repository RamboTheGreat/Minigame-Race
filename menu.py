...
def menu(screen, WIDTH, HEIGHT):
    # Modified from https://gist.github.com/ohsqueezy/2802185
    class Option:
        hovered = False
    ...
    options = [Option("SINGLEPLAYER", (145, ((HEIGHT - option1_height)/ 2 - option2_height))), Option("MULTIPLAYER", (145, (HEIGHT - option2_height)/ 2)),
...
def choosePort(screen, WIDTH, HEIGHT):
    ...
    option3_width, option3_height = menu_font.size("EXIT")
    options = [Option('/dev/ttyACM0', (145, ((HEIGHT - option1_height)/ 2 - option2_height))), Option("/dev/ttyACM1", (145, (HEIGHT - option2_height)/ 2)),
               Option("EXIT", (145, ((HEIGHT - option3_height)/ 2 + option2_height)))]
    
    while True:
        pygame.event.pump()
        screen.fill(colors.black)
        screen.blit(option0_message, (145, ((HEIGHT - option0_height)/ 2 - option1_height * 2)))
...
def checkPlayerReady(screen, WIDTH, HEIGHT):
    ...
    option3_width, option3_height = menu_font.size("EXIT")
    options = [Option('YES', (145, ((HEIGHT - option1_height)/ 2 - option2_height))), Option("NO", (145, (HEIGHT - option2_height)/ 2)),
               Option("EXIT", (145, ((HEIGHT - option3_height)/ 2 + option2_height)))]
...
def minigamechooser(screen, WIDTH, HEIGHT):
    ...
    options = [Option('Dodge!', (145, ((HEIGHT - option1_height)/ 2 - 3*option2_height))), Option("Falling!", (145, (HEIGHT - option2_height)/ 2 - 2*option2_height)),
               Option("Snake Evolved", (145, ((HEIGHT - option3_height)/ 2 - option2_height))),Option("Catch", (145, ((HEIGHT - option4_height)/ 2))),
               Option("Pop!", (145, ((HEIGHT - option3_height)/ 2 + option2_height))), Option("Jump!", (145, ((HEIGHT - option3_height)/ 2 + 2 * option2_height))),
               Option("Back", (145, ((HEIGHT - option3_height)/ 2 + 3 *option2_height))), Option("Exit", (145, ((HEIGHT - option3_height)/ 2 + 4*option2_height)))]
    time.sleep(.2)

    while True:
        pygame.event.pump()
        screen.fill(colors.black)
        screen.blit(option0_message, (145, ((HEIGHT - option0_height)/ 2 - option1_height * 4)))
...
def SinglePlayerMode(screen, WIDTH, HEIGHT):
    ...
    option3_width, option3_height = menu_font.size("EXIT")  
    options = [Option('Race', (145, ((HEIGHT - option1_height)/ 2 - option2_height))), Option("Minigames", (145, (HEIGHT - option2_height)/ 2)),
               Option("EXIT", (145, ((HEIGHT - option3_height)/ 2 + option2_height)))]
    while True:
        pygame.event.pump()
        screen.fill(colors.black)
