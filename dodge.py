...
def falling(screen, WIDTH, HEIGHT, clock, difficulty, timer1, mode):
    ...
    obj1 = objectsfordodge.Object(0, random.randint(0, HEIGHT),
    ...
    while runnning:
        ...
        if (random.randrange(0, 100) < difficulty + (player1.score/10)):
            ...
            if comingfrom == 1:
                newobj = objectsfordodge.Object(-1, random.randint(0, HEIGHT),
                    random.randint(2, round(difficulty+player1.score/10)),
                    random.randint(2, round(difficulty+player1.score/10)),
                    random.randint(0, 5), 1)
            elif comingfrom == 2:
                newobj = objectsfordodge.Object(random.randint(0, WIDTH),
                    -1, random.randint(2, round(difficulty+player1.score/10)),
                    random.randint(2, round(difficulty+player1.score/10)),
                    random.randint(0, 5), 1)
            elif comingfrom == 3:
                newobj = objectsfordodge.Object(random.randint(0, WIDTH),
                    601, random.randint(2, round(difficulty+player1.score/10)),
                    random.randint(2, round(difficulty+player1.score/10)),
                    random.randint(0, 5), 3)
            elif comingfrom == 4:
                newobj = objectsfordodge.Object(801, random.randint(0, HEIGHT),
                    random.randint(2, round(difficulty+player1.score/10)),
                    random.randint(2, round(difficulty+player1.score/10)),
                    random.randint(0, 5), 3)
            elif comingfrom == 5:
                ...
                newobj = objectsfordodge.Object(random.randint(0, WIDTH), -1,
                random.randint(2, round(difficulty+player1.score/10)),
                    random.randint(2, round(difficulty+player1.score/10)),
                    random.randint(0, 5), 4)
